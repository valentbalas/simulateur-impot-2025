...
class MoteurImpot:
    """Calcul IR 2024 complet — Brochure DGFiP 2025"""
    ...
    JOBS_ETUDIANTS_EXONERATION = 5_301
    ...
    def calculer(self, p: dict) -> dict:
        ...
        rev_ap = (sal1_imp + pen1 + sal2_imp + pen2) - abatt
        ...
        rni = max(0.0, rev_ap - ded_per - pen_vers + pen_recu - ab_pr)
